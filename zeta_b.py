...
dz_b = fn.diff_matrix( grid_params , 'neumann' , 'neumann' , diff_order=1 , stencil_size=3 ) # non-dimensional  
dzz_b = fn.diff_matrix( grid_params , 'neumann' , 'neumann' , diff_order=2 , stencil_size=3 ) # non-dimensional
