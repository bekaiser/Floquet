...
from functions import check_matrix, rk4, rk4_test, ordered_prod
...
M = [2,5,10,50,100,200,500,1000,10000] 
...
plotname = figure_path +'LTE_semilogy.png' #%(start_time,end_time)
